...
local VisualInterpolator = require("chart.model.visual.VisualInterpolator")
local FullEventScroller = require("chart.model.visual.FullEventScroller")
local Point = require("chart.model.tp.Point")
local VisualPoint = require("chart.model.visual.VisualPoint")

---@class chart.Visual
---@operator call: chart.Visual
---@field points chart.VisualPoint[]
---@field points_map {[chart.VisualPoint]: true}
---@field p2vp {[chart.Point]: chart.VisualPoint}
local Visual = class()
...
local MonotonicEventScroller = require("chart.model.visual.MonotonicEventScroller")
