...
local LinePreReductor = require("chart.transform.LinePreReductor")
local NoteCountReductor = require("chart.transform.NoteCountReductor")
local LineBalancer = require("chart.transform.LineBalancer")
local NoteApplyer = require("chart.transform.NoteApplyer")
local LongNoteReductor = require("chart.transform.LongNoteReductor")

---@class chart.Reductor
---@operator call: chart.Reductor
