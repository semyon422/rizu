...
function TestFixtures.sampleChart()
	return TestFixtures.chart1({
		SPN = {
			...
			{tick = 0, type = 2, lane = 0, value = 1},
			{tick = 0, type = 0, lane = 0, value = 0},
			{tick = 750, type = 2, lane = 7, value = 2},
			{tick = 750, type = 0, lane = 7, value = 0},
		...
		DPN = {
			...
			{tick = 0, type = 12, lane = 0, value = 0},
			{tick = 1500, type = 12, lane = 0, value = 0},
			{tick = 0, type = 2, lane = 1, value = 1},
			{tick = 0, type = 0, lane = 1, value = 0},
			{tick = 750, type = 3, lane = 2, value = 2},
			{tick = 750, type = 1, lane = 2, value = 0},
			{tick = 900, type = 7, lane = 0, value = 3},
		},
	})
end
