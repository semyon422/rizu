...
function SongSelect:new(ui)
	...
	end, ui.localization, ui.game.online_client, ui.game.avatar_cache)
	self.chart_browser = ChartBrowser(ui, ui.game.chartSelector, ui.game.settings, ui.tooltip, ui.localization)
...
function SongSelect:onHandleInputs(inputs)
	local game = self.ui.game
	if inputs:consumeActionJustPressed(UiActions.open_modifiers) then
