...
return {
	...
	bass_fx = {
		linux = { url = "http://www.un4seen.com/files/z/0/bass_fx24-linux.zip", archive = "bass_fx-linux.zip" },
		windows = { url = "https://www.un4seen.com/files/bass_fx24.zip", archive = "bass_fx-win.zip" },
		macos = { url = "https://www.un4seen.com/files/bass_fx24-osx.zip", archive = "bass_fx-macos.zip" },
	},
	bassopus = {
