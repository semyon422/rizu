...
local LocationCommands = require("yi.commands.LocationCommands")
local PlayConfigCommands = require("yi.commands.PlayConfigCommands")
local NoteSkinCommands = require("yi.commands.NoteSkinCommands")
local PackageCommands = require("yi.commands.PackageCommands")
local OnlineCommands = require("yi.commands.OnlineCommands")
local DatabaseCommands = require("yi.commands.DatabaseCommands")
local MultiplayerCommands = require("yi.commands.MultiplayerCommands")
