...
---@class yi.command_palette.Registry
---@operator call: yi.command_palette.Registry
---@field global_commands yi.command_palette.Command[]
---@field contextual_commands {[string]: yi.command_palette.Command[]}
...
---@param command yi.command_palette.Command
...
---@return yi.command_palette.Command[] active_commands
function Registry:getActiveCommands()
	---@type yi.command_palette.Command[]
	local list = {}
