...
---@class rizu.NormalscoreScore: rizu.ScoreSystem, rizu.IAccuracySource, rizu.IScoreSource
---@operator call: rizu.NormalscoreScore
...
---@return rizu.NormalscoreScore.Slice
function NormalscoreScore:getSlice()
	---@class rizu.NormalscoreScore.Slice
	local t = {
